                        ...
                        <div class="col-md-6 col-md-3 text-md-left">
                            <div class="d-inline-block inset-md-left-20 inset-lg-left-0">
                                ...
                                <div class="pull-right shadow-drop-xs d-inline-block select-xs">
                                    ...
                                    <span class="select2 select2-container select2-container--bootstrap select2-container--focus" dir="ltr" style="width: 120px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-regula-generated-764271-container">
                                                <span class="select2-selection__rendered" id="select2-regula-generated-764271-container" title="Popularity">Popularity</span>
                ...
                <div class="col-md-11 col-lg-3 text-lg-left">
                    ...
                    <aside class="blog-aside box box-xs d-block bg-default">
                        <div class="blog-aside-item">
                            ...
                            <!-- RD Search Form-->
                            {{ Form::open(['route' => ['blog.search'], 'method' => 'get','class' => 'form-blog-search form-blog-search-type-2 form-search rd-search']) }}
